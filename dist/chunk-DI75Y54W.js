...
var AnalysisSchema = z.object({
  ...
  ai_provider: z.object({
    ...
    api_key_env: z.string().default("DOCWALK_AI_KEY").describe("Environment variable name holding the API key"),
  ...
  max_file_size: z.number().int().positive().default(5e5),
  ...
  qa_config: z.object({
    ...
    context_window: z.number().default(4e3),
...
var SyncSchema = z.object({
  ...
  commit_message: z.string().default("docs: update documentation [docwalk]")
});
var DeploySchema = z.object({
   ...
   */
  provider: z.enum(["gh-pages", "cloudflare", "vercel", "netlify", "s3"]).default("gh-pages"),
...
var ThemeSchema = z.object({
  ...
  layout: z.enum(["tabs", "sidebar", "tabs-sticky"]).default("tabs"),
  /** MkDocs Material color palette preset */
  palette: z.enum(["default", "slate", "indigo", "deep-purple", "teal", "custom"]).default("slate"),
...
var DocWalkConfigSchema = z.object({
